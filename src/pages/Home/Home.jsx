...
const Home = () => {
  ...
  const deleteNote = async (data) => {
    ...
    try {
      const res = await axios.delete(
        `https://stg27notesappminorprojectsarvani.onrender.com/api/note/delete/${noteId}`,
        { withCredentials: true }
      )
  ...
  const onSearchNote = async (query) => {
    try {
      const res = await axios.get(`https://stg27notesappminorprojectsarvani.onrender.com/api/note/search`, {
        params: { query },
        withCredentials: true,
      })
  ...
  const updateIsPinned = async (noteData) => {
    ...
    try {
      const res = await axios.put(
        "https://stg27notesappminorprojectsarvani.onrender.com/api/note/update-note-pinned/" + noteId,
  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        ...
        {/* Tag Filter Dropdown at the bottom */}
        <div className="flex items-center gap-2 justify-center mt-8 mb-4">
